...
export const levels: LevelDef[] = [
  // ── Chapter 1: First Beats ─────────────────────────────────
  {
    ...
    description:
      'Welcome! In Strudel, `sound()` plays a sound. Replace `???` with `bd` to play a bass drum.',
    type: 'completion',
    targetCode: 'sound("bd")',
    starterCode: 'sound("???")',
  ...
  },
  {
    ...
    title: 'A Simple Beat',
    description:
      'Put multiple sounds in a sequence by separating them with spaces. Fill in the blanks to create: kick, hi-hat, snare, hi-hat.',
    type: 'completion',
    targetCode: 'sound("bd hh sd hh")',
    starterCode: 'sound("bd ??? sd ???")',
    hints: [
  ...
  // ── Chapter 2: Finding Notes ───────────────────────────────
  {
    ...
    title: 'First Notes',
    description:
      'Use `note()` to play pitched sounds. Fill in the blanks to play C, E, G, B on piano.',
    type: 'completion',
    targetCode: 'note("c e g b").sound("piano")',
    starterCode: 'note("c ??? g ???").sound("piano")',
    hints: [
  ...
  },
  {
    ...
    title: 'Scale Degrees',
    description:
      'Use `n()` with numbers and `.scale()` to play notes in a scale. Fill in the missing scale degrees to make a rising pattern.',
    type: 'completion',
    targetCode: 'n("0 2 4 6").scale("C:minor").sound("piano")',
    starterCode: 'n("0 ??? 4 ???").scale("C:minor").sound("piano")',
    hints: [
  ...
  },
  {
    ...
    starterCode: '$: note("c4 e4 g4 e4").sound("piano")\n$: sound("???")',
    hints: [
  ...
  },
  {
    ...
    starterCode: 'n("").scale("A:minor").sound("piano")',
    hints: [
  ...
  // ── Chapter 3: Sound Design ────────────────────────────────
  {
    ...
    starterCode: 'sound("bd hh*4 sd hh*4").???(???)',
    hints: [
  ...
  },
  {
    ...
    starterCode: 'note("c4 e4 g4 e4").sound("piano").gain(0.7).???(???)',
    hints: [
  ...
  },
  {
    ...
    starterCode: '$: note("").sound("sawtooth")\n$: sound("")',
    hints: [
